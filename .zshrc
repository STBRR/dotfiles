...
alias bgfix="feh --bg-center ~/Documents/spacemars-blur.png"
...
# [dev]
alias pve="ssh root@192.168.0.150"  # proxmox cluster
alias dev="ssh root@192.168.0.250"  # dev host - ubuntu lxc 
...
alias boxes="cd ~/HTB/boxes && ls -l"
alias labs="sudo openvpn ~/HTB/vpn/vip-labs.ovpn 2>/dev/null"
